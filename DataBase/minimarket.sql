...
CREATE TABLE `detalle_factura` (
  ...
  `sku` varchar(50),                                        -- CORREGIDO: coma faltante
...
CREATE TABLE `mov_inventario` (
  ...
  `id_factura` int,                                         -- CORREGIDO: coma faltante
  `motivo` varchar(255)
);
...
-- SUGERIDO: evita que un proveedor tenga el mismo codigo_proveedor apuntando a dos SKUs distintos
CREATE UNIQUE INDEX `uq_equiv_codigo_proveedor` ON `equivalencia_sku` (`codigo_proveedor`, `rut_proveedor`);
